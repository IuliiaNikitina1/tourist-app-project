...
import CategSquares from "../components/CategSquares";
...
const SquaresPage = () => {
    ...
    const [data, setData] = useState(CategSquares);
    ...
    const handleChange = (e) => {
        e.preventDefault();
        const result = CategSquares.filter((curData) => {
        ...
        if (Object.keys(result).length === 0) {
            ...
            placeForNotification.insertAdjacentHTML('beforeend','<div> Увы, такой площади нет в нашем списке </div>');
    ...
    return (
        ...
        <div>
            <form className="form-search">
                <input type="search" id="search" className="form-search__input" placeholder="Введите название площади..."></input>
            ...
            <div className="sights-container">
                ...
                return (
                    ...
                    <div className="sight-item__wrapper" key={id}>
                        <button className="sight-item__favourite" onClick={() => {saved_squares.push(id); localStorage.setItem("saved_squares", JSON.stringify(saved_squares));}}></button>
